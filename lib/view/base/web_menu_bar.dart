  ...
  Widget build(BuildContext context) {
    ...
    return Center(child: Container(
      ...
      child: Row(children: [
        ...
        MenuButtons(icon: Icons.home, title: 'home'.tr, onTap: () => Get.toNamed(RouteHelper.getInitialRoute())),
        SizedBox(width: 20),
        MenuButtons(icon: Icons.search, title: 'search'.tr, onTap: () => Get.toNamed(RouteHelper.getSearchRoute())),
        SizedBox(width: 20),
        MenuButtons(icon: Icons.notifications, title: 'notification'.tr, onTap: () => Get.toNamed(RouteHelper.getNotificationRoute())),
        SizedBox(width: 20),
        MenuButtons(icon: Icons.favorite_outlined, title: 'favourite'.tr, onTap: () => Get.toNamed(RouteHelper.getMainRoute('favourite'))),
        SizedBox(width: 20),
        MenuButtons(icon: Icons.shopping_cart, title: 'my_cart'.tr, isCart: true, onTap: () => Get.toNamed(RouteHelper.getCartRoute())),
        SizedBox(width: 20),
        MenuButtons(icon: Icons.menu, title: 'menu'.tr, onTap: () {
...
class MenuButtons extends StatelessWidget {
  ...
  MenuButtons({@required this.icon, @required this.title, this.isCart = false, @required this.onTap});
